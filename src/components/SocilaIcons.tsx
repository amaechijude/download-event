...
export function SocialIconsLucidReact() {
  const socialLinks: SocialLinksProps[] = [
    {
      tittle: "Facebook",
      href: "https://web.facebook.com/people/Download-Tech-Event/61577574789291",
      icon: <FacebookSvg />,
    ...
    {
      tittle: "Instagram",
      href: "https://www.instagram.com/downloadtechevent?igsh=MWs5Z243N29xMnJnMg==",
      icon: <InstagramSvg />,
